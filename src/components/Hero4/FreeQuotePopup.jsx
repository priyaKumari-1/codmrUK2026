...
//     const [technology, setTechnology] = useState("");
//     const optionsMap = {
//         "Development": ["CRM Development", "Building LLM", ".NET Application", "React Application", "Python Application"],
//         "CRM": ["Salesforce", "Custom CRM"],
//         "Integration": ["API Integration", "Data Migration", "Data Integration"],
//         "Support": ["Technical Support", "Deployment Support"]
//     };
...
//                         &times;
//                     </button>
//                     <h3 className="text-center">Get Your Free Quote</h3>
...
//                 <div className="popup-body">
//                     {!submitted ? (
//                         <form action="https://test.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8&orgId=00DAe000009CRc3" method="POST">
//                             <input type="hidden" name="oid" value="00DAe000009CRc3" />
//                             <input type="hidden" name="retURL" value="http://www.codmsoftware.co.uk" />
//                             {/* First & Last Name */}
//                             <div className="form-row">
//                                 <div className="form-group">
//                                     <label>
...
//                                 >
//                                     <option value="">
//                                         {service ? "Select Technology" : "Select Service First"}
//                                     </option>
...
//                             <button type="submit" className="submit-btn mt-4 m-md-0" name="submit">
//                                 Submit Quote Request
//                             </button>
//                         </form>
//                     ) : (
