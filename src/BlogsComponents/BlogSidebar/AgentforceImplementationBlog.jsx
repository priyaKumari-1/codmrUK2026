...
import chanderkant from '../../assets/imgs/services-details-2/triggerframework/chanderkant.png';
import bgImg from '../../assets/imgs/services-details/bg-line-3.png';

function AgentforceImplementationBlog() {
  return (
    <div>
        <BlogSidebar/>
                        {/* next section  */}
                         <div className="mt-5" style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                            ...
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/irdNqlytsLc?si=uASeiMU6aRni6ctf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen  style={{
                                    position: "absolute",
                                    top: 0,
                                    left: 0,
                                    width: "100%",
                        ...
                        <div class="developer-info mt-4 pt-3">
                            <div class="d-flex align-items-center">
                                <img src={chanderkant} alt="prachi pathak" class="rounded-circle me-3" width={'100%'} />
...
export default AgentforceImplementationBlog;
